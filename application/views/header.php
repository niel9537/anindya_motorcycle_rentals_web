...
<head>
  ...
  <style>
    ...
    @media(max-width:767px) {
      body {
        /* Body offset for fixed navbar for mobile devices */
        padding-top: 140px;
      }

      .navbar .navbar-form {
        width: 100%
          /* Full width search box for mobile devices */
      }
    }
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <div class="logo">
            <a href="<?php echo base_url(); ?>">Anindya Rental</a>
          </div>
        </div>
        ...
        <div class="collapse navbar-collapse upper-navbar">
          <ul class="nav navbar-nav ">
            ...
            <li><a href="<?php echo base_url('produk'); ?>">Rental</a></li>
          ...
          <ul id="menu-topmenu" class="nav navbar-nav navbar-right">
            ...
            <?php } else { ?>
              <li><a href="<?php echo base_url('sewa'); ?>">List Sewa</a></li>
