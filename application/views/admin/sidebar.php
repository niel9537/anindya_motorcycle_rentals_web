<aside class="main-sidebar">
  <section class="sidebar">
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="<?php echo base_url('data_produk') ?>"><i class="fa fa-motorcycle"></i> <span>Produk</span></a></li>
      <li><a href="<?php echo base_url('data_transaksi_sewa') ?>"><i class="fa fa-credit-card"></i> <span>Transaksi Sewa</span></a></li>
      <li><a href="<?php echo base_url('laporan_sewa') ?>"><i class="fa fa-list-alt"></i> Laporan Transaksi</a></li>
